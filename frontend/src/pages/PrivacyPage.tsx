  ...
  return (
    <div className="min-h-screen bg-surface">
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <h1 className="mb-2 mt-4 text-2xl font-semibold text-ink">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-sm leading-6 text-ink-dim">
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-ink">How it's stored</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-ink">Who we share it with</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-ink">How to delete your data</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-ink">Your rights (GDPR)</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-ink">India DPDP Act</h2>
            <p>
